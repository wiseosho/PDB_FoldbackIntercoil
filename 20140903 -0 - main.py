...
def Construct_FBI(maydai):
	#41,42,43,44 : 100 010 001 000
	### start sequence : 15 - 25(24)
	for k in range (30):
		ang = -1*PII
		for j in range(14, 16):
			for i in range (j, len(maydai)):
				maydai[i] = Rotation_base(maydai[i], maydai[j][42]-maydai[j][44] , maydai[j][44], ang)
...
def main():
	...
	mayday[0] = Construct_FBI(mayday[0])
